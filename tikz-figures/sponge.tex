...
\begin{tikzpicture}
  ...
  \draw[brace] (y51) ++(\outputoff,.5em) -- node[right=\textmargin] {output} ++(0,-2*\branchdistance - 1em);
  ...
  \coordinate[xshift=-2*\outputoff, yshift=\ratevertmarg] (r1) at (x1);
  \coordinate[xshift=-2*\outputoff, yshift=-\ratevertmarg] (r2) at (x3);
  \draw[brace] (r2) -- (r1) node[left=\textmargin,pos=0.5] {rate};

  \coordinate[xshift=-2*\outputoff, yshift=\ratevertmarg] (c1) at (x4);
  \coordinate[xshift=-2*\outputoff, yshift=-\ratevertmarg] (c2) at (x6);
  \draw[brace] (c2) -- (c1) node[left=\textmargin,pos=0.5] {capacity};
\end{tikzpicture}
\end{document}
